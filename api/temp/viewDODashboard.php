...
function get_bcTPB()
{
    global $db;
    $dataGetBC = $db->query("SELECT NOMOR_AJU,KODE_DOKUMEN_PABEAN,
                            (SELECT COUNT(*) AS total_bc FROM tpb_header WHERE KODE_DOKUMEN_PABEAN IS NOT NULL) AS total_bc
                            FROM tpb_header
                            WHERE KODE_DOKUMEN_PABEAN IS NOT NULL
                            ORDER BY ID DESC LIMIT 1", 0);
    $cek = $dataGetBC->num_rows;
...
function get_bc23()
{
    ...
    $dataGetBC23 = $db->query("SELECT NOMOR_AJU,
                            (SELECT COUNT(*) AS total_bc23 FROM tpb_header WHERE KODE_DOKUMEN_PABEAN=23 AND KODE_DOKUMEN_PABEAN IS NOT NULL) AS total_bc23
                            FROM tpb_header
...
function get_bc25()
{
    ...
    $dataGetBC25 = $db->query("SELECT NOMOR_AJU,
                            (SELECT COUNT(*) AS total_bc25 FROM tpb_header WHERE KODE_DOKUMEN_PABEAN=25 AND KODE_DOKUMEN_PABEAN IS NOT NULL) AS total_bc25
                            FROM tpb_header
...
function get_bc261()
{
    ...
    $dataGetBC261 = $db->query("SELECT NOMOR_AJU,
                            (SELECT COUNT(*) AS total_bc261 FROM tpb_header WHERE KODE_DOKUMEN_PABEAN=261 AND KODE_DOKUMEN_PABEAN IS NOT NULL) AS total_bc261
                            FROM tpb_header
...
function get_bc27()
{
    ...
    $dataGetBC27 = $db->query("SELECT NOMOR_AJU,
                            (SELECT COUNT(*) AS total_bc27 FROM tpb_header WHERE KODE_DOKUMEN_PABEAN=27 AND KODE_DOKUMEN_PABEAN IS NOT NULL) AS total_bc27
                            FROM tpb_header
...
function get_bc40()
{
    ...
    $dataGetBC40 = $db->query("SELECT NOMOR_AJU,
                            (SELECT COUNT(*) AS total_bc40 FROM tpb_header WHERE KODE_DOKUMEN_PABEAN=40 AND KODE_DOKUMEN_PABEAN IS NOT NULL) AS total_bc40
                            FROM tpb_header
...
function get_bc41()
{
    ...
    $dataGetBC41 = $db->query("SELECT NOMOR_AJU,
                            (SELECT COUNT(*) AS total_bc41 FROM tpb_header WHERE KODE_DOKUMEN_PABEAN=41 AND KODE_DOKUMEN_PABEAN IS NOT NULL) AS total_bc41
                            FROM tpb_header
