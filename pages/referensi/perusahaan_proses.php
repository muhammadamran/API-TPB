...
if ($aksi == 'insert') {
    ...
    $update = $db->query('UPDATE referensi_pengusaha SET NPPBKC="' . $NPPBKC . '" WHERE id="' . $id . '"');

    if ($update) {
        echo '<script>alert("Data has been Updated");location.href = "../../index.php?m=referensi&s=perusahaan&t=Perusahaan"</script>';
    } else {
