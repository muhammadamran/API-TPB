<?php
// $data = $db->query("SELECT *,pmk.ID,pmk.NAMA AS nama_pemasok,sts.KODE_STATUS,sts.URAIAN_STATUS FROM tpb_header AS hdr 
//                     JOIN referensi_pemasok AS pmk ON hdr.ID_PEMASOK=pmk.ID
//                     JOIN referensi_status AS sts ON hdr.KODE_STATUS=sts.KODE_STATUS 
//                     WHERE hdr.KODE_DOKUMEN_PABEAN=23 GROUP BY hdr.ID_MODUL", 0);
