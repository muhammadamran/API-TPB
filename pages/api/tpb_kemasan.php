...
<?php
// TOTAL RECORD
$dataD = $dbmain->query("SELECT COUNT(*) AS total FROM tpb_kemasan ORDER BY ID DESC");
$rowD  = $dataD->fetch_assoc();
// LAST RECORD
$dataLastD = $dbmain->query("SELECT * FROM tpb_kemasan ORDER BY ID DESC LIMIT 1");
$rowLastD  = $dataLastD->fetch_assoc();
?>
<!-- LOCAL -->
<?php
// TOTAL RECORD
$dataL = $db->query("SELECT COUNT(*) AS total FROM tpb_kemasan ORDER BY ID DESC");
$rowL  = $dataL->fetch_assoc();
// LAST RECORD
$dataLastL = $db->query("SELECT * FROM tpb_kemasan ORDER BY ID DESC LIMIT 1");
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Data TPB Kemasan</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body" style="display: flex;justify-content: space-between;align-content: center;align-items: center;">
                    <div>
                        ...
                        <?php if ($btnContpb_kemasan == 'synchron') { ?>
                            <button class="btn btn-success"><i class="fas fa-check-circle"></i> Data Sudah Synchronize</button>
                        <?php } else { ?>
                            <a href="index.php?m=api&s=tpb_kemasan_sync&t=Sync Data TPB Kemasan" class="btn btn-primary"><i class="fas fa-refresh"></i> Synchronize Manually</a>
                        <?php } ?>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="card ">
                <div class="card-header ">
                    <font class="card-title"><i class="fas fa-table"></i> Data IT Inventory <?= $btnContpb_kemasan ?></font>
                </div>
                <div class="card-body ">
                    ...
                    <div class="alert alert-secondary fade show" style="color: #66615b;">
                        ...
                        <p>Menampilkan <b>Limit <?= $Limit_D ?> Data TPB Kemasan</b> terakhir. Silahkan tambah Limit Data TPB Kemasan pada form Limit.<br> Total Data TPB Kemasan pada Sistem sebanyak <b><?= $rowD['total'] ?> Data TPB Kemasan.</b></p>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <table id="domain" class="table table-striped table-bordered table-td-valign-middle">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-nowrap" style="text-align: center;">KODE JENIS KEMASAN</th>
                                    <th class="text-nowrap" style="text-align: center;">MERK KEMASAN</th>
                                    <th class="text-nowrap" style="text-align: center;">NIP GATE IN</th>
                                    <th class="text-nowrap" style="text-align: center;">NIP GATE OUT</th>
                                    <th class="text-nowrap" style="text-align: center;">NO POLISI</th>
                                    <th class="text-nowrap" style="text-align: center;">NOMOR SEGEL</th>
                                    <th class="text-nowrap" style="text-align: center;">SERI KEMASAN</th>
                            ...
                            <tbody>
                                <?php include 'pages/api/data/tpb_kemasan_d.php'; ?>
                            </tbody>
                        </table>
                    </div>
                </div>
            ...
            <div class="card ">
                ...
                <div class="card-body ">
                    ...
                    <div class="alert alert-secondary fade show" style="color: #66615b;">
                        ...
                        <p>Menampilkan <b>Limit <?= $Limit_L ?> Data TPB Kemasan</b> terakhir. Silahkan tambah Limit Data TPB Kemasan pada form Limit.<br> Total Data TPB Kemasan pada Sistem sebanyak <b><?= $rowL['total'] ?> Data TPB Kemasan.</b></p>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                            <form action="" method="POST">
                    ...
                    <div class="table-responsive">
                        <table id="local" class="table table-striped table-bordered table-td-valign-middle">
                            ...
                            <tbody>
                                <?php include 'pages/api/data/tpb_kemasan_l.php'; ?>
                            </tbody>
                        </table>
                    </div>
                </div>
