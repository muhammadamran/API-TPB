...
if ($query) {
    echo '<script>alert("Data has been Added");location.href = "../../index.php?m=api&s=tpb_kontainer&t=Data TPB Pungutan"</script>';
} else {
    echo '<script>alert("Data failed Added");location.href = "../../index.php?m=api&s=tpb_kontainer&t=Data TPB Pungutan"</script>';
}
