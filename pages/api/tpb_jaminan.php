...
<?php
// TOTAL RECORD
$dataD = $dbmain->query("SELECT COUNT(*) AS total FROM tpb_jaminan ORDER BY ID DESC");
$rowD  = $dataD->fetch_assoc();
// LAST RECORD
$dataLastD = $dbmain->query("SELECT * FROM tpb_jaminan ORDER BY ID DESC LIMIT 1");
$rowLastD  = $dataLastD->fetch_assoc();
?>
<!-- LOCAL -->
<?php
// TOTAL RECORD
$dataL = $db->query("SELECT COUNT(*) AS total FROM tpb_jaminan ORDER BY ID DESC");
$rowL  = $dataL->fetch_assoc();
// LAST RECORD
$dataLastL = $db->query("SELECT * FROM tpb_jaminan ORDER BY ID DESC LIMIT 1");
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Data TPB Jaminan</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body" style="display: flex;justify-content: space-between;align-content: center;align-items: center;">
                    <div>
                        ...
                        <?php if ($btnContpb_jaminan == 'synchron') { ?>
                            <button class="btn btn-success"><i class="fas fa-check-circle"></i> Data Sudah Synchronize</button>
                        <?php } else { ?>
                            <a href="index.php?m=api&s=tpb_jaminan_sync&t=Sync Data TPB Jaminan" class="btn btn-primary"><i class="fas fa-refresh"></i> Synchronize Manually</a>
                        <?php } ?>
                    </div>
                </div>
            </div>
            ...
            <div class="card ">
                ...
                <div class="card-body ">
                    ...
                    <div class="alert alert-secondary fade show" style="color: #66615b;">
                        ...
                        <p>Menampilkan <b>Limit <?= $Limit_D ?> Data TPB Jaminan</b> terakhir. Silahkan tambah Limit Data TPB Jaminan pada form Limit.<br> Total Data TPB Jaminan pada Sistem sebanyak <b><?= $rowD['total'] ?> Data TPB Jaminan.</b></p>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <table id="domain" class="table table-striped table-bordered table-td-valign-middle">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-nowrap" style="text-align: center;">KODE JENIS JAMINAN</th>
                                    <th class="text-nowrap" style="text-align: center;">KODE KANTOR</th>
                                    <th class="text-nowrap" style="text-align: center;">NILAI JAMINAN</th>
                                    <th class="text-nowrap" style="text-align: center;">NOMOR BPJ</th>
                                    <th class="text-nowrap" style="text-align: center;">NOMOR JAMINAN</th>
                                    <th class="text-nowrap" style="text-align: center;">PENJAMIN</th>
                                    <th class="text-nowrap" style="text-align: center;">TANGGAL BPJ</th>
                                    <th class="text-nowrap" style="text-align: center;">TANGGAL JAMINAN</th>
                                    <th class="text-nowrap" style="text-align: center;">TANGGAL JATUH TEMPO</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php include 'pages/api/data/tpb_jaminan_d.php'; ?>
                            </tbody>
                        </table>
                    </div>
                </div>
            ...
            <div class="card ">
                ...
                <div class="card-body ">
                    ...
                    <div class="alert alert-secondary fade show" style="color: #66615b;">
                        ...
                        <p>Menampilkan <b>Limit <?= $Limit_L ?> Data TPB Jaminan</b> terakhir. Silahkan tambah Limit Data TPB Jaminan pada form Limit.<br> Total Data TPB Jaminan pada Sistem sebanyak <b><?= $rowL['total'] ?> Data TPB Jaminan.</b></p>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                            <form action="" method="POST">
                    ...
                    <div class="table-responsive">
                        <table id="local" class="table table-striped table-bordered table-td-valign-middle">
                            ...
                            <tbody>
                                <?php include 'pages/api/data/tpb_jaminan_l.php'; ?>
                            </tbody>
                        </table>
                    </div>
                </div>
