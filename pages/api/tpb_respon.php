...
<?php
// TOTAL RECORD
$dataD = $dbmain->query("SELECT COUNT(*) AS total FROM tpb_respon ORDER BY ID DESC");
$rowD  = $dataD->fetch_assoc();
// LAST RECORD
$dataLastD = $dbmain->query("SELECT * FROM tpb_respon ORDER BY ID DESC LIMIT 1");
$rowLastD  = $dataLastD->fetch_assoc();
?>
<!-- LOCAL -->
<?php
// TOTAL RECORD
$dataL = $db->query("SELECT COUNT(*) AS total FROM tpb_respon ORDER BY ID DESC");
$rowL  = $dataL->fetch_assoc();
// LAST RECORD
$dataLastL = $db->query("SELECT * FROM tpb_respon ORDER BY ID DESC LIMIT 1");
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Data TPB Respon</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card ">
                ...
                <div class="card-body ">
                    ...
                    <div class="alert alert-secondary fade show" style="color: #66615b;">
                        ...
                        <p>Menampilkan <b>Limit <?= $Limit_D ?> Data TPB Respon</b> terakhir. Silahkan tambah Limit Data TPB Respon pada form Limit.<br> Total Data TPB Respon pada Sistem sebanyak <b><?= $rowD['total'] ?> Data TPB Respon.</b></p>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <table id="domain" class="table table-striped table-bordered table-td-valign-middle">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-nowrap" style="text-align: center;">BYTE STREM PDF</th>
                                    <th class="text-nowrap" style="text-align: center;">FLAG BACA</th>
                                    <th class="text-nowrap" style="text-align: center;">KODE RESPON</th>
                                    <th class="text-nowrap" style="text-align: center;">NOMOR AJU</th>
                                    <th class="text-nowrap" style="text-align: center;">NOMOR RESPON</th>
                                    <th class="text-nowrap" style="text-align: center;">TANGGAL RESPON</th>
                                    <th class="text-nowrap" style="text-align: center;">WAKTU RESPON</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php include 'pages/api/data/tpb_respon_d.php'; ?>
                            </tbody>
                        </table>
                    </div>
                </div>
            ...
            <div class="card ">
                ...
                <div class="card-body ">
                    ...
                    <div class="alert alert-secondary fade show" style="color: #66615b;">
                        ...
                        <p>Menampilkan <b>Limit <?= $Limit_L ?> Data TPB Respon</b> terakhir. Silahkan tambah Limit Data TPB Respon pada form Limit.<br> Total Data TPB Respon pada Sistem sebanyak <b><?= $rowL['total'] ?> Data TPB Respon.</b></p>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                            <form action="" method="POST">
                    ...
                    <div class="table-responsive">
                        <table id="local" class="table table-striped table-bordered table-td-valign-middle">
                            ...
                            <tbody>
                                <?php include 'pages/api/data/tpb_respon_l.php'; ?>
                            </tbody>
                        </table>
                    </div>
                </div>
