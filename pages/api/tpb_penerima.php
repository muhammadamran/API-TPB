...
<?php
// TOTAL RECORD
$dataD = $dbmain->query("SELECT COUNT(*) AS total FROM tpb_penerima ORDER BY ID DESC");
$rowD  = $dataD->fetch_assoc();
// LAST RECORD
$dataLastD = $dbmain->query("SELECT * FROM tpb_penerima ORDER BY ID DESC LIMIT 1");
$rowLastD  = $dataLastD->fetch_assoc();
?>
<!-- LOCAL -->
<?php
// TOTAL RECORD
$dataL = $db->query("SELECT COUNT(*) AS total FROM tpb_penerima ORDER BY ID DESC");
$rowL  = $dataL->fetch_assoc();
// LAST RECORD
$dataLastL = $db->query("SELECT * FROM tpb_penerima ORDER BY ID DESC LIMIT 1");
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Data TPB Penerima</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body" style="display: flex;justify-content: space-between;align-content: center;align-items: center;">
                    <div>
                        ...
                        <?php if ($btnContpb_penerima == 'synchron') { ?>
                            <button class="btn btn-success"><i class="fas fa-check-circle"></i> Data Sudah Synchronize</button>
                        <?php } else if ($btnContpb_penerima == '404') { ?>
                            <button class="btn btn-warning"><i class="fas fa-exclamation-circle"></i> Data Kosong</button>
                        <?php } else { ?>
                            <a href="index.php?m=api&s=tpb_penerima_sync&t=Sync Data TPB Penerima" class="btn btn-primary"><i class="fas fa-refresh"></i> Synchronize Manually</a>
                        <?php } ?>
                    </div>
                </div>
            </div>
            ...
            <div class="card ">
                ...
                <div class="card-body ">
                    ...
                    <div class="alert alert-secondary fade show" style="color: #66615b;">
                        ...
                        <p>Menampilkan <b>Limit <?= $Limit_D ?> Data TPB Penerima</b> terakhir. Silahkan tambah Limit Data TPB Penerima pada form Limit.<br> Total Data TPB Penerima pada Sistem sebanyak <b><?= $rowD['total'] ?> Data TPB Penerima.</b></p>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <table id="domain" class="table table-striped table-bordered table-td-valign-middle">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-nowrap" style="text-align: center;">NAMA PENERIMA</th>
                                    <th class="text-nowrap" style="text-align: center;">ALAMAT PENERIMA</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php include 'pages/api/data/tpb_penerima_d.php'; ?>
                            </tbody>
                        </table>
                    </div>
                </div>
            ...
            <div class="card ">
                ...
                <div class="card-body ">
                    ...
                    <div class="alert alert-secondary fade show" style="color: #66615b;">
                        ...
                        <p>Menampilkan <b>Limit <?= $Limit_L ?> Data TPB Penerima</b> terakhir. Silahkan tambah Limit Data TPB Penerima pada form Limit.<br> Total Data TPB Penerima pada Sistem sebanyak <b><?= $rowL['total'] ?> Data TPB Penerima.</b></p>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                            <form action="" method="POST">
                    ...
                    <div class="table-responsive">
                        <table id="local" class="table table-striped table-bordered table-td-valign-middle">
                            ...
                            <tbody>
                                <?php include 'pages/api/data/tpb_penerima_l.php'; ?>
                            </tbody>
                        </table>
                    </div>
                </div>
