...
<?php
// TOTAL RECORD
$dataD = $dbmain->query("SELECT COUNT(*) AS total FROM tpb_bahan_baku_tarif ORDER BY ID DESC");
$rowD  = $dataD->fetch_assoc();
// LAST RECORD
$dataLastD = $dbmain->query("SELECT * FROM tpb_bahan_baku_tarif ORDER BY ID DESC LIMIT 1");
$rowLastD  = $dataLastD->fetch_assoc();
?>
<!-- LOCAL -->
<?php
// TOTAL RECORD
$dataL = $db->query("SELECT COUNT(*) AS total FROM tpb_bahan_baku_tarif ORDER BY ID DESC");
$rowL  = $dataL->fetch_assoc();
// LAST RECORD
$dataLastL = $db->query("SELECT * FROM tpb_bahan_baku_tarif ORDER BY ID DESC LIMIT 1");
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Data TPB Bahan Baku Tarif</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body" style="display: flex;justify-content: space-between;align-content: center;align-items: center;">
                    <div>
                        ...
                        <?php if ($btnContpb_bahan_baku_tarif == 'synchron') { ?>
                            <button class="btn btn-success"><i class="fas fa-check-circle"></i> Data Sudah Synchronize</button>
                        <?php } else { ?>
                            <a href="index.php?m=api&s=tpb_bahan_baku_tarif_sync&t=Sync Data TPB Bahan Baku Tarif" class="btn btn-primary"><i class="fas fa-refresh"></i> Synchronize Manually</a>
                        <?php } ?>
                    </div>
                </div>
            </div>
            ...
            <div class="card ">
                ...
                <div class="card-body ">
                    ...
                    <div class="alert alert-secondary fade show" style="color: #66615b;">
                        ...
                        <p>Menampilkan <b>Limit <?= $Limit_D ?> Data TPB Bahan Baku Tarif</b> terakhir. Silahkan tambah Limit Data TPB Bahan Baku Tarif pada form Limit.<br> Total Data TPB Bahan Baku Tarif pada Sistem sebanyak <b><?= $rowD['total'] ?> Data TPB Bahan Baku Tarif.</b></p>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <table id="domain" class="table table-striped table-bordered table-td-valign-middle">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-nowrap" style="text-align: center;">KODE ASAL BAHAN BAKU</th>
                                    <th class="text-nowrap" style="text-align: center;">KODE FASILITAS</th>
                                    <th class="text-nowrap" style="text-align: center;">KODE KOMODITI CUKAI</th>
                                    <th class="text-nowrap" style="text-align: center;">KODE SATUAN</th>
                                    <th class="text-nowrap" style="text-align: center;">KODE TARIF</th>
                                    <th class="text-nowrap" style="text-align: center;">NILAI BAYAR</th>
                                    <th class="text-nowrap" style="text-align: center;">NILAI FASILITAS</th>
                                    <th class="text-nowrap" style="text-align: center;">NILAI SUDAH DILUNASI</th>
                                    <th class="text-nowrap" style="text-align: center;">SERI BAHAN BAKU</th>
                                    <th class="text-nowrap" style="text-align: center;">SERI BARANG</th>
                                    <th class="text-nowrap" style="text-align: center;">TARIF</th>
                                    <th class="text-nowrap" style="text-align: center;">TARIF FASILITAS</th>
                                    <th class="text-nowrap" style="text-align: center;">ID BAHAN BAKU</th>
                                    <th class="text-nowrap" style="text-align: center;">ID BARANG</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php include 'pages/api/data/tpb_bahan_baku_tarif_d.php'; ?>
                            </tbody>
                        </table>
                    </div>
                </div>
            ...
            <div class="card ">
                ...
                <div class="card-body ">
                    ...
                    <div class="alert alert-secondary fade show" style="color: #66615b;">
                        ...
                        <p>Menampilkan <b>Limit <?= $Limit_L ?> Data TPB Bahan Baku Tarif</b> terakhir. Silahkan tambah Limit Data TPB Bahan Baku Tarif pada form Limit.<br> Total Data TPB Bahan Baku Tarif pada Sistem sebanyak <b><?= $rowL['total'] ?> Data TPB Bahan Baku Tarif.</b></p>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                            <form action="" method="POST">
                    ...
                    <div class="table-responsive">
                        <table id="local" class="table table-striped table-bordered table-td-valign-middle">
                            ...
                            <tbody>
                                <?php include 'pages/api/data/tpb_bahan_baku_tarif_l.php'; ?>
                            </tbody>
                        </table>
                    </div>
                </div>
